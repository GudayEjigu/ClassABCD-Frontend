...
import QuestionAnswerReplyReportsAdd from "./QuestionAnswerReplyReportsAdd";
  ...
  return (
    <div>
      ...
      <div className="flex justify-end p-2">
        ...
        >
          Add Question Answer Reply Report
        </button>
      </div>
      {showModal ? (
        <QuestionAnswerReplyReportsAdd setShowModal={setShowModal} />
      ) : null}
      {QARReportData.error ? (
